...
function headerAnim() {
  ...
  //     function () {
  //         $(this).find('::before').css('transform', 'scaleX(1)');
  //         console.log(123)
  //     },
  //     function () {
  //         $(this).find('::before').css('transform', 'scaleX(0)');
  //         console.log(321)
  //     }
  // );
}
/* harmony default export */ var header = (headerAnim);
...
;// CONCATENATED MODULE: ./src/js/components/about.js
...
/* harmony default export */ var about = (initMap);
;// CONCATENATED MODULE: ./src/js/components/smoothScroll.js
const smoothScroll_scroll = () => {
